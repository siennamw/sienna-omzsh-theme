...
PROMPT=$'
%{$purple%}%n${PR_RST} at %{$orange%}%m${PR_RST}$(python_prompt)$(node_prompt) in %{$limegreen%}%~${PR_RST} $vcs_info_msg_0_$(virtualenv_info)
$ '
